...
class PluginSubscriptions::Notice
  include ActiveModel::Serialization

  PLUGIN_STATUS_DOMAINS = {
    "main" => "plugins.discourse.plugin.tech",
    "master" => "plugins.discourse.plugin.tech",
    "tests-passed" => "plugins.discourse.plugin.tech",
    "stable" => "stable.plugins.discourse.plugin.tech"
  }
  ...
  def self.publish_notice_count
    ...
    MessageBus.publish("/plugin-subs/notices", payload, group_ids: [Group::AUTO_GROUPS[:admins]])
  end
  ...
  def self.request(archetype)
    ...
    connection_error = PluginSubscriptions::Notice::ConnectionError.new(archetype)
  ...
  def self.namespace
    "#{PluginSubscriptions::PLUGIN_NAME}_notice"
  end
